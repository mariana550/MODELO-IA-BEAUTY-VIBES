...
Se identifica una necesidad o situación que puede ser analizada mediante datos.

**Recolección de datos:** 
Se obtienen datos relevantes para el problema.

**Preparación de datos:** 
Se limpian, transforman y organizan los datos.
...
**Evaluación:** 
Se miden los resultados del modelo.

**Despliegue:** 
El modelo se integra en un sistema real (opcional en proyectos académicos).